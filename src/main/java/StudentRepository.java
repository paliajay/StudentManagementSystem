//step 4. This is the class that connects to DB
...
public class StudentRepository {
    ...
    public void createTable(){
        ...
        try {
            String query = "CREATE TABLE IF NOT EXISTS tbl_student (" +
                    "id SERIAL UNIQUE, name VARCHAR(50) NOT NULL CHECK(LENGTH(name)>0)," +//empty ""
